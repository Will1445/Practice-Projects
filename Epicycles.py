...
while running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN: # Sets program to 'take data' state
            state = 1
            
        if event.type == pygame.KEYDOWN: # Calculates the fourier coefficients from the collected data and sets state to 'play'
